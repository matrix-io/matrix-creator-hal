...
int main() {
  ...
  // printf("mag_y:\t\t%x\n", imu_data.mag_y);
  // printf("mag_z:\t\t%x\n", imu_data.mag_z);
  // printf("mag_offset_x:\t\t%x\n", imu_data.mag_offset_x);
  // printf("mag_offset_y:\t\t%x\n", imu_data.mag_offset_y);
  // printf("mag_offset_z:\t\t%x\n", imu_data.mag_offset_z);
  ...
  // imu_sensor.SetCompassCalibration(0,0,0,&imu_data);

  while(1){
    imu_sensor.Read(&imu_data);

    printf("%x\t", *(unsigned int*)&imu_data.yaw);
    printf("%x\t", *(unsigned int*)&imu_data.pitch);
    printf("%x\t", *(unsigned int*)&imu_data.roll);
    printf("%x\t", *(unsigned int*)&imu_data.accel_x);
    printf("%x\t", *(unsigned int*)&imu_data.accel_y);
    printf("%x\t", *(unsigned int*)&imu_data.accel_z);
    printf("%x\t", *(unsigned int*)&imu_data.gyro_x);
    printf("%x\t", *(unsigned int*)&imu_data.gyro_y);
    printf("%x\t", *(unsigned int*)&imu_data.gyro_z);
    printf("%x\t", *(unsigned int*)&imu_data.mag_x);
    printf("%x\t", *(unsigned int*)&imu_data.mag_y);
    printf("%x\t", *(unsigned int*)&imu_data.mag_z);
    printf("%x\t", *(unsigned int*)&imu_data.mag_offset_x);
    printf("%x\t", *(unsigned int*)&imu_data.mag_offset_y);
    printf("%x\t", *(unsigned int*)&imu_data.mag_offset_z);
    printf("\n");
